    ...
    <footer className="bg-gray-900 text-gray-300">
      <div className="container mx-auto px-4 py-12 md:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
          <div className="lg:col-span-2">
            <Link href="/" className="flex items-center space-x-2 mb-6">
              ...
              <span className="font-bold text-xl text-white">LegalFirm</span>
            </Link>
            <p className="mb-6 max-w-md">
              Providing exceptional legal services for over 25 years. Our team
              of experienced attorneys is dedicated to helping clients navigate
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p>&copy; {currentYear} LegalFirm. All rights reserved.</p>
